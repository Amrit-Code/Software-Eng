        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <form action="http://webprojects.eecs.qmul.ac.uk/as396/se19/ExamRegister.php" method="POST">
            ...
            <div class="form-group row middle">
                ...
                <div class="col-sm-10">
                <textarea class="form-control numRec" id="exampleFormControlTextarea1" rows="1" name = "ExamID" required></textarea>
                </div>
            </div>
            <button type="submit" class="registerbtn middle" id="submit">Register</button>
        </form>
