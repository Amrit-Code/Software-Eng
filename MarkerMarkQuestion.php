            ...
            <form action="http://webprojects.eecs.qmul.ac.uk/as396/se19/SaveMarkingMarker.php" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control col-md-1" id="Mark" name="Mark" id="Mark"><label for="exampleInputEmail1" class="col-md-4 numRec" required>/'.$Marks.'</label><br></br>
                        <small id="emailHelp" class="form-text text-muted">Please enter a value smaller than the max.</small>
                    </div>
                    <button type="submit" value="'.$AnsID.'" name = "AnsID" class="btn btn-primary" id="submit">Mark Question</button>
                </div>
                </form>
            </div>
            ';
