            ...
            <?php 
                ...
                if(sizeof($Exams) == 0){
                    ...
                    foreach($Exams as $Exam){
                        ...
                        $MinStay = $row["MinStay"];
                        $EndTime =  $row["EndTime"];
                        if(strlen((string)$StartTime) == 3){
                            $STime = ("0").((String)$StartTime[0]).":".((String)$StartTime[1]).((String)$StartTime[2]);
                        }else{
                        ...
                        <div class="card middle">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Exam Date : '.$EDate.'</h5>
                                    ...
                                    <br>You can not leave in the first '.$MinStay.'min and you can not leave in the last '.$EndTime.'min</p> <br>';
                                    if(date("d-m-Y") == $EDate){
